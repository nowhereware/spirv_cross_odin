...
Sampler_Addressing_Mode :: enum i32 {
	None           = 0,
	ClampToEdge    = 1,
	Clamp          = 2,
	Repeat         = 3,
...
Image_Channel_Data_Type :: enum i32 {
	SnormInt8           = 0,
	SnormInt16          = 1,
	UnormInt8           = 2,
	UnormInt16          = 3,
...
Image_Operands_Flags :: bit_set[Image_Operands_Flag;u32]

FP_Fast_Math_Mode_Flag :: enum u32 {
	NotNaNShift                 = 0,
	NotInfShift                 = 1,
	NSZShift                    = 2,
	AllowRecipShift             = 3,
...
FP_Fast_Math_Mode_Flags :: bit_set[FP_Fast_Math_Mode_Flag;u32]

FP_Rounding_Mode :: enum i32 {
	RTE = 0,
	RTZ = 1,
	RTP = 2,
	RTN = 3,
...
Linkage_Type :: enum i32 {
	Export      = 0,
	Import      = 1,
	LinkOnceODR = 2,
}

Access_Qualifier :: enum i32 {
	ReadOnly  = 0,
	WriteOnly = 1,
	ReadWrite = 2,
}

Function_Parameter_Attribute :: enum i32 {
	Zext                = 0,
	Sext                = 1,
	ByVal               = 2,
	Sret                = 3,
...
Selection_Control_Flag :: enum u32 {
	Flatten     = 0,
	DontFlatten = 1,
}
Selection_Control_Flags :: bit_set[Selection_Control_Flag;u32]

Loop_Control_Flag :: enum u32 {
	Unroll                    = 0,
	DontUnroll                = 1,
...
Loop_Control_Flags :: bit_set[Loop_Control_Flag;u32]

Function_Control_Flag :: enum u32 {
	Inline       = 0,
	DontInline   = 1,
	Pure         = 2,
	Const        = 3,
...
Function_Control_Flags :: bit_set[Function_Control_Flag;u32]

Memory_Semantics_Flag :: enum u32 {
	Acquire                = 1,
	Release                = 2,
	AcquireRelease         = 3,
...
Memory_Semantics_Flags :: bit_set[Memory_Semantics_Flag;u32]

Memory_Access_Flag :: enum u32 {
	Volatile                = 0,
	Aligned                 = 1,
	Nontemporal             = 2,
...
Memory_Access_Flags :: bit_set[Memory_Access_Flag;u32]
...
Kernel_Enqueue_Flag :: enum i32 {
	NoWait        = 0,
	WaitKernel    = 1,
	WaitWorkGroup = 2,
}
Kernel_Enqueue_Flags :: bit_set[Kernel_Enqueue_Flag;u32]

Kernel_Profiling_Info_Flag :: enum u32 {
	CmdExecTimeShift = 0,
}
Kernel_Profiling_Info_Flags :: bit_set[Kernel_Profiling_Info_Flag;u32]
...
Ray_Flags :: bit_set[Ray_Flag;u32]

Ray_Query_Intersection :: enum i32 {
	RayQueryCandidateIntersectionKHR = 0,
	RayQueryCommittedIntersectionKHR = 1,
}

Ray_Query_Committed_Intersection_Type :: enum i32 {
	NoneKHR      = 0,
	TriangleKHR  = 1,
	GeneratedKHR = 2,
}

Ray_Query_Candidate_Intersection_Type :: enum i32 {
	TriangleKHR = 0,
	AABBKHR     = 1,
}

Fragment_Shading_Rate_Flag :: enum u32 {
	Vertical2Pixels   = 0,
	Vertical4Pixels   = 1,
	Horizontal2Pixels = 2,
	Horizontal4Pixels = 3,
}
Fragment_Shading_Rate_Flags :: bit_set[Fragment_Shading_Rate_Flag;u32]

FP_Denorm_Mode :: enum i32 {
	Preserve    = 0,
	FlushToZero = 1,
}

FP_Operation_Mode :: enum i32 {
	IEEE = 0,
	ALT  = 1,
}

Quantization_Modes :: enum i32 {
	TRN          = 0,
	TRN_ZERO     = 1,
	RND          = 2,
	RND_ZERO     = 3,
...
Packed_Vector_Format :: enum i32 {
	Bit4x8    = 0,
	Bit4x8KHR = 0,
}

Cooperative_Matrix_Operands_Flag :: enum u32 {
...
Cooperative_Matrix_Operands_Flags :: bit_set[Cooperative_Matrix_Operands_Flag;u32]

Cooperative_Matrix_Layout :: enum i32 {
	RowMajorKHR                 = 0,
	ColumnMajorKHR              = 1,
...
Cooperative_Matrix_Use :: enum i32 {
	AKHR           = 0,
	BKHR           = 1,
	AccumulatorKHR = 2,
}

Cooperative_Matrix_Reduce_Flag :: enum u32 {
	Row    = 0,
	Column = 1,
	_2x2   = 2,
}
Cooperative_Matrix_Reduce_Flags :: bit_set[Cooperative_Matrix_Reduce_Flag;u32]

Tensor_Clamp_Mode :: enum i32 {
	Undefined      = 0,
	Constant       = 1,
	ClampToEdge    = 2,
	Repeat         = 3,
...
Tensor_Addressing_Operands_Flag :: enum u32 {
	TensorView = 0,
	DecodeFunc = 1,
}
Tensor_Addressing_Operands_Flags :: bit_set[Tensor_Addressing_Operands_Flag;u32]

Tensor_Operands_Flag :: enum u32 {
	NontemporalARM          = 0,
...
Tensor_Operands_Flags :: bit_set[Tensor_Operands_Flag;u32]

Initialization_Mode_Qualifier :: enum i32 {
	InitOnDeviceReprogramINTEL = 0,
	InitOnDeviceResetINTEL     = 1,
}

Host_Access_Qualifier :: enum i32 {
	NoneINTEL      = 0,
	ReadINTEL      = 1,
	WriteINTEL     = 2,
	ReadWriteINTEL = 3,
...
Named_Maximum_Number_Of_Registers :: enum i32 {
	AutoINTEL = 0,
}

Matrix_Multiply_Accumulate_Operands_Flag :: enum u32 {
...
Matrix_Multiply_Accumulate_Operands_Flags :: bit_set[Matrix_Multiply_Accumulate_Operands_Flag;u32]

Raw_Access_Chain_Operands_Flag :: enum u32 {
	RobustnessPerComponentNV = 0,
	RobustnessPerElementNV   = 1,
}
Raw_Access_Chain_Operands_Flags :: bit_set[Raw_Access_Chain_Operands_Flag;u32]

FP_Encoding :: enum i32 {
	BFloat16KHR   = 0,
	Float8E4M3EXT = 4214,
	Float8E5M2EXT = 4215,
}

Cooperative_Vector_Matrix_Layout :: enum i32 {
	RowMajorNV           = 0,
	ColumnMajorNV        = 1,
